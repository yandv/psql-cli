...
Manage:
  ...
  psql-cli export [--out f] [--generate]        export all connections (encrypted) to move to another machine
  psql-cli import <file> [--replace]            import an encrypted export (restores passwords)
